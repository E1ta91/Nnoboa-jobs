    ...
    <div>
      <div className='flex flex-col md:flex-row'>
        ...
        <div className='bg-white w-full md:w-2/6 h-screen overflow-y-auto space-y-6 p-6 md:p-7 hide-scrollbar'>
          ...
          <div className='space-y-5'>
            <h1 style={{ fontFamily: 'moon' }} className='text-2xl sm:text-3xl font-medium text-center md:text-left'>
              Harvest Your Dream Job - Join Now!
            </h1>
            ...
            <form className='space-y-5'>
              ...
              <div className='space-y-2 flex flex-col'>
                <label htmlFor="name" className='text-[#3a5629] font-medium'>Full Name</label>
                <input
                  type="text"
                  id='name'
              ...
              {/* Email Input */}
              <div className='space-y-2 flex flex-col'>
                <label htmlFor="email" className='text-[#3a5629] font-medium'>Email Address</label>
                <input
                  type="email"
                  id='email'
            ...
            <Link to='/esignup' className='text-[#3a5629] font-medium'>Sign up as an employer</Link>
          </div>
        </div>
        ...
        <div className='hidden md:block w-full md:w-4/6 fixed top-0 right-0 h-screen'>
          <img src={s2} className='w-full h-full object-cover' alt="Background" />
